...
const ZNACKY = {
  hs: {
    ...
    note: 'Platí na všetkých štrnásť Head Spa rituálov, od 40 do 120 minút.',
    noteKratko: 'Platí na všetkých štrnásť Head Spa rituálov.',
    adresa: 'Mostná 226/30, Nitra', kontakt: '0911 153 136 · salon30.sk',
    kroky: ['Vyber si rituál, štrnásť Head Spa rituálov od 40 do 120 minút.',
            'Rezervuj si termín cez QR kód vedľa alebo telefonicky na 0911 153 136.',
            'Poukaz prines so sebou, stačí aj v telefóne.'],
    fakty: [['14', 'rituálov'], ['40 až 120', 'minút'], ['od 50 €', 'ceny rituálov'], ['Mostná 30', 'Nitra']],
    kto: 'HEAD SPA 30<br>v Salóne 30',
    faktyLice: [['14', 'rituálov'], ['40 až 120', 'minút'], ['od 50 €', 'ceny rituálov']],
  },
  s30: {
