...
const ZNACKY = {
  hs: {
    ...
    note: 'Platí na všetkých 34 rituálov pre hlavu aj pre chodidlá, od 40 do 120 minút.',
    noteKratko: 'Platí na všetkých 34 rituálov, pre hlavu aj pre chodidlá.',
    adresa: 'Mostná 226/30, Nitra', kontakt: '0911 153 136 · salon30.sk',
    kroky: ['Vyber si rituál pre hlavu alebo pre chodidlá, 34 rituálov od 40 do 120 minút.',
            'Rezervuj si termín cez QR kód vedľa alebo telefonicky na 0911 153 136.',
            'Poukaz prines so sebou, stačí aj v telefóne.'],
    fakty: [['34', 'rituálov'], ['17 + 17', 'hlava a chodidlá'], ['40 až 120', 'minút'], ['od 45 €', 'ceny rituálov']],
    kto: 'HEAD SPA 30<br>v Salóne 30',
    faktyLice: [['34', 'rituálov'], ['40 až 120', 'minút'], ['hlava + chodidlá', 'dve polovice ponuky']],
  },
  s30: {
